    ...
    this.experiences = [
      {
        ...
        duration: '2020 — 2024',
        summary: [
          'Built, maintained, and improved critical Spring Boot applications for the Architecture team.',
        ...
        skills: ['Java', 'Spring Boot', 'Angular', 'Docker', 'TypeScript'],
      },
      {
        title: 'EDI Intern',
        company: 'Cencora',
        duration: "Summer '19",
        summary: [
          'Developed an internal tool for the Electronic Data Interchange (EDI) team to ensure data integrity for b2b transactions.',
